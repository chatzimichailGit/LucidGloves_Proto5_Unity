...
#define LOOP_TIME 8 //How much time between data sends (ms), set to 0 for a good time :)
#define CALIBRATION_LOOPS 300//How many loops should be calibrated. Set to -1 to always be calibrated.
...
#define CLAMP_FLEXION true  //clamp the raw flexion values
